...
router.post("/career/roadmap", authMiddleware, async (req: AuthRequest, res) => {
  try {
    ...
    const interestMap: Record<string, CareerData> = {
      رياضيات: { careers: ["عالم بيانات", "محلل مالي", "مهندس برمجيات", "خبير إحصاء"], subjects: ["التفاضل والتكامل", "الإحصاء", "الجبر الخطي", "علم الحاسوب"], title: "الرياضيات والتحليل", visionTitle: "مسارك نحو السيادة العلمية", salary5yr: "18,000 - 28,000 ر.س/شهر", jobTitle5yr: "محلل بيانات أو مهندس أول" },
      علوم: { careers: ["باحث علمي", "مهندس أحياء دقيقة", "صيدلاني", "عالم بيئة"], subjects: ["الأحياء", "الكيمياء", "الفيزياء", "المنهجية العلمية"], title: "العلوم والبحث", visionTitle: "مسارك نحو اكتشافات تُغير العالم", salary5yr: "15,000 - 25,000 ر.س/شهر", jobTitle5yr: "باحث أول أو متخصص علوم" },
      تكنولوجيا: { careers: ["مهندس برمجيات", "مهندس ذكاء اصطناعي", "محلل أمن سيبراني", "مدير منتج"], subjects: ["علم الحاسوب", "هياكل البيانات", "الخوارزميات", "تصميم الأنظمة"], title: "التكنولوجيا والهندسة", visionTitle: "مسارك نحو قيادة الثورة الرقمية", salary5yr: "22,000 - 40,000 ر.س/شهر", jobTitle5yr: "مهندس برمجيات أول أو رئيس تقنية" },
      ذكاء: { careers: ["مهندس ذكاء اصطناعي", "عالم تعلم آلي", "باحث NLP", "مهندس بيانات"], subjects: ["الخوارزميات", "الإحصاء", "Python", "الشبكات العصبية"], title: "الذكاء الاصطناعي", visionTitle: "مسارك نحو صناعة المستقبل بيديك", salary5yr: "30,000 - 50,000 ر.س/شهر", jobTitle5yr: "مهندس ذكاء اصطناعي أول" },
      أعمال: { careers: ["رائد أعمال", "مدير تسويق", "مستشار مالي", "مدير استراتيجية"], subjects: ["الاقتصاد", "المحاسبة", "استراتيجية الأعمال", "التسويق"], title: "الأعمال وريادة الأعمال", visionTitle: "مسارك نحو السيادة المادية", salary5yr: "20,000 - 45,000 ر.س/شهر", jobTitle5yr: "مدير تنفيذي أو رائد أعمال ناجح" },
      طب: { careers: ["طبيب", "ممرض متخصص", "باحث طبي", "مدير رعاية صحية"], subjects: ["الأحياء", "الكيمياء", "علم التشريح", "أخلاقيات الطب"], title: "الطب والرعاية الصحية", visionTitle: "مسارك نحو إنقاذ الأرواح وصنع الفارق", salary5yr: "25,000 - 50,000 ر.س/شهر", jobTitle5yr: "طبيب مقيم متخصص" },
      تصميم: { careers: ["مصمم UX/UI", "مصمم جرافيك", "مهندس معماري", "مخرج إبداعي"], subjects: ["مبادئ التصميم", "الوسائط الرقمية", "نظرية الألوان", "Adobe Suite"], title: "التصميم والفنون الإبداعية", visionTitle: "مسارك نحو تشكيل الجماليات التي يراها العالم", salary5yr: "12,000 - 25,000 ر.س/شهر", jobTitle5yr: "مصمم أول أو مدير إبداعي" },
      قانون: { careers: ["محامي", "قاضي", "مستشار قانوني", "دبلوماسي"], subjects: ["الفقه القانوني", "القانون المدني", "الإجراءات الجنائية", "حقوق الإنسان"], title: "القانون والعدالة", visionTitle: "مسارك نحو حماية الحق والعدل", salary5yr: "18,000 - 35,000 ر.س/شهر", jobTitle5yr: "محامي متخصص أو مستشار قانوني" },
    };
