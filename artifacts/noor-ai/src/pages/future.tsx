...
import { Brain, ArrowRight, Compass, CheckCircle2, ChevronRight, Briefcase } from "lucide-react";
        ...
        {!roadmap && !generateRoadmap.isPending && (
          <div className="max-w-2xl mx-auto">
            <div className="text-center mb-10">
              ...
              <h1 className="text-4xl font-bold tracking-tight mb-4">Future Simulator</h1>
              ...
              <CardContent className="p-8">
                <form onSubmit={handleSubmit}>
                  {step === 1 && (
                    <div className="space-y-6 animate-in fade-in slide-in-from-right-4">
                      <div className="space-y-2">
                        ...
                        <p className="text-muted-foreground">Enter topics, hobbies, or fields you enjoy.</p>
                      </div>
                      <div className="space-y-3">
                        <Label htmlFor="interests">Interests (comma separated)</Label>
                        <Input 
                          id="interests" 
                          placeholder="e.g. artificial intelligence, space, writing, business" 
                          value={interests}
                  ...
                  {step === 2 && (
                    <div className="space-y-6 animate-in fade-in slide-in-from-right-4">
                      <div className="space-y-2">
                        <h2 className="text-2xl font-semibold tracking-tight">Where are you starting from?</h2>
                        <p className="text-muted-foreground">Select your current educational stage.</p>
                      </div>
                      <div className="space-y-3">
                        ...
                        <Select value={grade} onValueChange={setGrade}>
                          ...
                          <SelectContent>
                            ...
                            <SelectItem value="Post-grad/Professional">Professional / Post-grad</SelectItem>
                          </SelectContent>
                        </Select>
                      </div>
                    </div>
                  ...
                  {step === 3 && (
                    <div className="space-y-6 animate-in fade-in slide-in-from-right-4">
                      <div className="space-y-2">
                        <h2 className="text-2xl font-semibold tracking-tight">What's the dream?</h2>
                        <p className="text-muted-foreground">Describe your ultimate goal, even if it's vague.</p>
                      </div>
                      <div className="space-y-3">
                        <Label htmlFor="goals">Your Goals</Label>
                        <Textarea 
                          id="goals" 
                          placeholder="I want to build robots that help people, or maybe start my own tech company..." 
                          value={goals}
                  ...
                  <div className="flex justify-between items-center mt-10 pt-6 border-t">
                    ...
                    >
                      {step < 3 ? (
                        ...
                        <>Generate Roadmap <Brain className="ml-2 h-4 w-4" /></>
                      )}
                    </Button>
                  </div>
                </form>
        ...
        {generateRoadmap.isPending && (
          <div className="flex flex-col items-center justify-center py-32 space-y-6">
            ...
            <div className="text-center">
              <h2 className="text-2xl font-bold tracking-tight">Synthesizing Your Future</h2>
              <p className="text-muted-foreground mt-2">Analyzing billions of career pathways...</p>
            </div>
          </div>
        )}
                    ...
                    {roadmap.steps.map((step, idx) => (
                      <div key={idx} className="relative pl-8 pb-10 last:pb-0">
                        ...
                        <div className="flex flex-col sm:flex-row sm:items-baseline gap-2 mb-2">
                          ...
                          <span className="text-sm font-medium text-muted-foreground bg-secondary px-2 py-0.5 rounded-md w-fit">Phase {step.phase} • {step.duration}</span>
                        </div>
